...
def parse_threed_front_scenes(
    ...
    if os.getenv("PATH_TO_SCENES"):
        ...
        scenes = sum(scenes, [])
        pickle.dump(scenes, open("../../3d_front_preprocessed/threed_front.pkl", "wb")) #/tmp/threed_front.pkl
...
def parse_threed_future_models(
    ...
    if os.getenv("PATH_TO_3D_FUTURE_OBJECTS"):
        ...
        pickle.dump(furnitures, open("/localhome/xsa55/Xiaohao/DiffuScene/3d_front_preprocessed/threed_future_model.pkl", "wb")) #/tmp/threed_future_model.pkl
